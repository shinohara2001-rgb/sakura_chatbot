...
"""
    ...
    for i, msg in enumerate(st.session_state.messages):
        ...
        if i == len(st.session_state.messages) - 1 and role == "user":
            text_content += "\n\n[CRITICAL SYSTEM RULE: You MUST analyze the exact language used in this specific message and reply ONLY in that same language. If the message above is English, you MUST reply in English. Translating the information is strictly required.]"
